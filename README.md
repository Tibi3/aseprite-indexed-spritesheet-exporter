...
- Copy export-indexed-spritesheet.lua there.
- File -> Scripts -> Rescan Scripts Folder

## How to use

- Open a sprite
- File -> Scripts -> export-indexed-spritesheet
- Choose where to save the spritesheet
- Click confirm
- Set options for the spritesheet but DO NOT modify the output file path
- Click export
